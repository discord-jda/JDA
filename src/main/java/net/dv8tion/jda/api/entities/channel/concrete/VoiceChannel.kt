 ...
 * <br></br>Adds additional information specific to voice channels in Discord.
 *
 * @see GuildChannel
 *
 * @see TextChannel
 ...
 * @see JDA.getVoiceChannelsByName
 * @see JDA.getVoiceChannelById
 */
interface VoiceChannel : StandardGuildChannel, GuildMessageChannel, AudioChannel, IWebhookContainer,
    IAgeRestrictedChannel, ISlowmodeChannel, IVoiceStatusChannel {
    @Nonnull
    override fun createCopy(@Nonnull guild: Guild?): ChannelAction<VoiceChannel?>?
    @Nonnull
    override fun createCopy(): ChannelAction<VoiceChannel?>? {
    ...
    companion object {
        /**
         * The maximum limit you can set with [VoiceChannelManager.setUserLimit]. ({@value})
         */
        const val MAX_USERLIMIT = 99
    }
}
