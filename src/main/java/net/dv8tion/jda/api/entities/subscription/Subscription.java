...
public interface Subscription extends ISnowflake {
    ...
    /**
     * The SKU id's related to this Subscription
     *
     * @return The list of sku id's related to this Subscription
     */
    @Nonnull
    ...
    default List<String> getSkuIds() {
        return getSkuIdsLong().stream().map(Long::toUnsignedString).collect(Helpers.toUnmodifiableList());
    }
