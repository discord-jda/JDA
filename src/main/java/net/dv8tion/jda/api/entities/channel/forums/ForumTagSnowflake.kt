 ...
 * <br></br>This is primarily useful for creating posts with [ForumPostAction.setTags].
 */
interface ForumTagSnowflake : ISnowflake {
    companion object {
        /**
        ...
        @JvmStatic
        @Nonnull
        fun fromId(id: Long): ForumTagSnowflake? {
            return ForumTagSnowflakeImpl(id)
        }
         ...
         */
        @Nonnull
        fun fromId(@Nonnull id: String?): ForumTagSnowflake? {
            return ForumTagSnowflakeImpl(MiscUtil.parseSnowflake(id))
        }
    }
}
