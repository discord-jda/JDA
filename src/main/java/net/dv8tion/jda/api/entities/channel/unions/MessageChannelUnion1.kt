 ...
 * <br></br>This class extends [MessageChannel] and primarily acts as a discovery tool for
 * developers to discover some common interfaces that a [MessageChannel] could be cast to.
 *
 ...
 *
 */
interface MessageChannelUnion : MessageChannel {
    /**
    ...
    `</pre> *
     *
     * You can use [.getType][.isGuild()][ChannelType.isGuild] to validate
