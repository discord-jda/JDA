...
interface SelfUser : User {
     ...
     * <br></br>For most bots this is identical to the user id.
     *
     ...
     * <br></br>If this is a Client account, then this describes the MFA status of the Client account.
     * <br></br>If this is a Bot account, then this describes the MFA status of the Client account that owns this Bot.
     *
     ...
     * <br></br>Returns {@value net.dv8tion.jda.api.entities.Message#MAX_FILE_SIZE} for bots.
     *
