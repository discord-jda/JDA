...
enum class MessageType(
     ...
     * <br></br>Contains a button which allows to upgrade to premium.
     */
    INTERACTION_PREMIUM_UPSELL(26, true, true),

    /**
     * Messages created in [StageChannels][StageChannel] to indicate that a stage instance has started.
     * <br></br>The message content will be the [topic][StageInstance.getTopic] and the author is the user who started the stage instance.
     */
    STAGE_START(27, true, true),

    /**
     * Messages created in [StageChannels][StageChannel] to indicate that a stage instance has ended.
     * <br></br>The message content will be the [topic][StageInstance.getTopic] and the author is the user who ended the stage instance.
     */
    STAGE_END(28, true, true),

    /**
     * Messages created in [StageChannels][StageChannel] to indicate that a new [speaker][StageInstance.getSpeakers] is up.
     * <br></br>The author is the user who became speaker.
     */
    STAGE_SPEAKER(29, true, true),

    /**
     * Messages created in [StageChannels][StageChannel] to indicate that a stage instance topic has been changed.
     * <br></br>The message content will be the new [topic][StageInstance.getTopic] and the author is the user who updated the topic.
     */
    STAGE_TOPIC(31, true, true),

    /**
     * Sent to the [system channel][Guild.getSystemChannel] when a guild administrator subscribes to the premium plan of an application.
     */
     ...
     * <br></br>The message content is an ISO 8601 timestamp, which indicates when the action expires and disables the security measures automatically.
     *
     * @see java.time.OffsetDateTime.parse
     */
     ...
     * <br></br>The message author is the reporter.
     */
