 ...
 * <br></br>This class extends [GuildChannel] and primarily acts as a discovery tool for
 * developers to discover some common interfaces that a [GuildChannel] could be cast to.
 *
 ...
 *
 */
interface GuildChannelUnion : GuildChannel {
    /**
