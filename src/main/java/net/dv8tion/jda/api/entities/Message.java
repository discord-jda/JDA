...
public interface Message extends ISnowflake, Formattable
{
    ...
    */
    ...
    default MessageAction editMessage(@NotNull MessageEmbed newContent)
    {
    ...
    @NotNull
    @CheckReturnValue
    MessageAction editMessageComponents(@NotNull Collection<? extends ComponentLayout> components);
    ...
    @NotNull
    @CheckReturnValue
    default MessageAction editMessageComponents(@NotNull ComponentLayout... components)
    {
