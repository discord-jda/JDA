...
public interface Message extends ISnowflake, Formattable
{
    ...
    /**
     * Gets the textual content of this message using {@link #getContentDisplay()} and then strips it of all spoiler tags 
     * and markdown characters like {@literal *, **, __, ~~, ||} that provide text formatting. Any characters that match these 
     * but are not being used for formatting are escaped to prevent possible formatting.
     *
