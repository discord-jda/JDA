 ...
 * [Guild.getDefaultChannel] or [Member.getDefaultChannel].
 * <br></br>This is the channel that the Discord client will default to opening when a Guild is opened for the first time
 * when accepting an invite that is not directed at a specific [channel][net.dv8tion.jda.api.entities.channel.attribute.IInviteContainer].
 *
 * <br></br>This class extends [StandardGuildChannel] and primarily acts as a discovery tool for
 ...
 *
 */
interface DefaultGuildChannelUnion : StandardGuildChannel {
    /**
