...
public interface Member extends IMentionable, IPermissionHolder, UserReference
{
     ...
     *
     * <p>A Member's roles can be changed using the {@link Guild#addRoleToMember(UserReference, Role)}, {@link Guild#removeRoleFromMember(UserReference, Role)}, and {@link Guild#modifyMemberRoles(Member, Collection, Collection)}
     ...
     *
     * @see    Guild#addRoleToMember(UserReference, Role)
     * @see    Guild#removeRoleFromMember(UserReference, Role)
