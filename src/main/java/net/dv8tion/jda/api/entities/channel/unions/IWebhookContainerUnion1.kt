...
/**
 * A union representing all channel types that implement [net.dv8tion.jda.api.entities.channel.attribute.IWebhookContainer].
 * <br></br>This class extends [net.dv8tion.jda.api.entities.channel.attribute.IWebhookContainer] and primarily acts as a discovery tool for
 * developers to discover some common interfaces that a [net.dv8tion.jda.api.entities.channel.attribute.IWebhookContainer] could be cast to.
 *
 ...
 *
 */
interface IWebhookContainerUnion : IWebhookContainer {
    /**
