 ...
 *     </li>
 *     <li>The member is an interaction option (such as slash command option or a member {@link net.dv8tion.jda.api.components.selects.EntitySelectMenu EntitySelectMenu} value)
 *         and the channel is the {@link net.dv8tion.jda.api.interactions.Interaction#getGuildChannel() interaction channel}
 *     </li>
