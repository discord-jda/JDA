 ...
 */
abstract class GenericGuildStickerUpdateEvent<T>(
    @Nonnull api: JDA, responseNumber: Long,
    @Nonnull guild: Guild?, @Nonnull sticker: GuildSticker?,
    @get:Nonnull
    @param:Nonnull override val propertyIdentifier: String, protected val previous: T, protected val next: T
) : GenericGuildStickerEvent(api, responseNumber, guild, sticker), UpdateEvent<GuildSticker?, T?> {
    @get:Nonnull
