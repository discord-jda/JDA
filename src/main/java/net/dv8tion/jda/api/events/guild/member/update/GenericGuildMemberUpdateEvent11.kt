 ...
 * <br></br>Every GuildMemberUpdateEvent is an instance of this event and can be casted.
 *
 *
 ...
 */
abstract class GenericGuildMemberUpdateEvent<T>(
    @Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member,
    previous: T?, next: T?, @Nonnull identifier: String
) : GenericGuildMemberEvent(api, responseNumber, member), UpdateEvent<Member?, T?> {
