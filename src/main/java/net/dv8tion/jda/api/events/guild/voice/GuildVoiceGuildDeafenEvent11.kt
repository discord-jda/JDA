...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] was (un-)deafened by a moderator.
 *
 *
 ...
 */
class GuildVoiceGuildDeafenEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
     ...
     * <br></br>False, if a moderator un-deafened this member
     */
    val isGuildDeafened: Boolean

    init {
        isGuildDeafened = member.voiceState!!.isGuildDeafened
    }
}
