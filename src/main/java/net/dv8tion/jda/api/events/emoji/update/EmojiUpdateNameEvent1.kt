...
/**
 * Indicates that the name of a [Custom Emoji][RichCustomEmoji] changed.
 *
 *
...
class EmojiUpdateNameEvent(
    ...
    @Nonnull oldName: String?
) : GenericEmojiUpdateEvent<String?>(api, responseNumber, emoji, oldName, emoji.name, IDENTIFIER) {
    @get:Nonnull
    val oldName: String?
        /**
         * The old name
