...
/**
 * Indicates that you joined a [Guild][net.dv8tion.jda.api.entities.Guild] that is not yet available.
 * **This does not extend [GenericGuildEvent][net.dv8tion.jda.api.events.guild.GenericGuildEvent]**
 * <br></br>This will be followed by a [GuildAvailableEvent] once the guild becomes available again.
 *
 *
