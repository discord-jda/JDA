...
/**
 * Indicates that a [Channel&#39;s][Channel] auto archive duration has been updated.
 *
 *
...
class ChannelUpdateAutoArchiveDurationEvent(
    ...
    responseNumber: Long,
    channel: Channel,
    oldValue: AutoArchiveDuration?,
    newValue: AutoArchiveDuration?
) : GenericChannelUpdateEvent<AutoArchiveDuration?>(api, responseNumber, channel, FIELD, oldValue, newValue) {
    companion object {
        val FIELD = ChannelField.AUTO_ARCHIVE_DURATION
