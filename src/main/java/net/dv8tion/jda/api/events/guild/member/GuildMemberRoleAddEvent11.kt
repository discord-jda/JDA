...
/**
 * Indicates that one or more [Roles][net.dv8tion.jda.api.entities.Role] were assigned to a [Member][net.dv8tion.jda.api.entities.Member].
 *
 *
...
class GuildMemberRoleAddEvent(
    ...
    init {
        roles = Collections.unmodifiableList(addedRoles)
    }
}
