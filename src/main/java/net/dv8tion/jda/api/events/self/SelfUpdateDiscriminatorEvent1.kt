...
@ForRemoval @Deprecated(
    ...
    class SelfUpdateDiscriminatorEvent (@Nonnull api:JDA?, responseNumber:kotlin.Long, @Nonnull oldDiscriminator:kotlin.String?) : GenericSelfUpdateEvent<kotlin.String?>(api, responseNumber, oldDiscriminator, api.getSelfUser().getDiscriminator(), SelfUpdateDiscriminatorEvent.Companion.IDENTIFIER) {
    /**
