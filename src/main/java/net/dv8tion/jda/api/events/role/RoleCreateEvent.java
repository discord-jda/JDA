...
{
    public RoleCreateEvent(@Nonnull JDA api, long responseNumber, @Nullable DataObject rawData, @Nonnull Role createdRole)
    {
        super(api, responseNumber, rawData, createdRole);
    }
}
