...
/**
 * Indicates that a [User][net.dv8tion.jda.api.entities.User] changed or started an activity.
 * <br></br>Every UserEvent is derived from this event and can be casted.
 *
 *
 * Can be used to detect any UserEvent.
 */
abstract class GenericUserEvent(
