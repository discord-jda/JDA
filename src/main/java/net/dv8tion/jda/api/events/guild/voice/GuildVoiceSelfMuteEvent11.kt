...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] (un-)muted itself.
 *
 *
 ...
 */
class GuildVoiceSelfMuteEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
     ...
     * <br></br>False, if the member un-muted itself
     */
    val isSelfMuted: Boolean

    init {
        isSelfMuted = member.voiceState!!.isSelfMuted
    }
}
