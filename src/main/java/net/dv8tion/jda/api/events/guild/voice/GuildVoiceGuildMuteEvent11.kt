...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] was (un-)muted by a moderator.
 *
 *
 ...
 */
class GuildVoiceGuildMuteEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
     ...
     * <br></br>False, if a moderator un-muted this member
     */
    val isGuildMuted: Boolean

    init {
        isGuildMuted = member.voiceState!!.isGuildMuted
    }
}
