...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] joined a [Guild][net.dv8tion.jda.api.entities.Guild].
 *
 *
 ...
 */
class GuildMemberJoinEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
