 ...
 * <br></br>All Objects have been replaced when this is fired and events were likely missed in the downtime.
 *
 *
 ...
 */
class SessionRecreateEvent(@Nonnull api: JDA) : GenericSessionEvent(api, SessionState.RECREATED)
