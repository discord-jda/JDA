...
/**
 * Indicates that a new [Custom Emoji][RichCustomEmoji] was added to a [Guild][net.dv8tion.jda.api.entities.Guild].
 *
 *
 * **Requirements**<br></br>
 *
 ...
 */
class EmojiAddedEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull emoji: RichCustomEmoji) :
    GenericEmojiEvent(api, responseNumber, emoji)
