...
/**
 * Indicates that a [Channel&#39;s][Channel] position has been updated.
 *
 *
 * Can be used to retrieve the old position and the new one.
 *
 *
 * Limited to [IPositionableChannels][IPositionableChannel] (and implementations).
 *
...
class ChannelUpdatePositionEvent(
    ...
    companion object {
        val FIELD = ChannelField.POSITION
