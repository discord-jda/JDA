...
/**
 * Indicates that a custom {@link UserSelectMenu} on one of the bots messages was used by a user.
 *
 ...
 */
public class UserSelectMenuInteractionEvent extends GenericComponentInteractionCreateEvent implements UserSelectMenuInteraction
{
    private final UserSelectMenuInteraction menuInteraction;

    public UserSelectMenuInteractionEvent(@Nonnull JDA api, long responseNumber, @Nonnull UserSelectMenuInteraction interaction)
    {
    ...
    @Nonnull
    @Override
    public UserSelectMenuInteraction getInteraction()
    {
