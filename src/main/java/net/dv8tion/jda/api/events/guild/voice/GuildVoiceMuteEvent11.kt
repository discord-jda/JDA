...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] was (un-)muted.
 * <br></br>Combines [GuildVoiceGuildMuteEvent][net.dv8tion.jda.api.events.guild.voice.GuildVoiceGuildMuteEvent]
 * and [GuildVoiceSelfMuteEvent][net.dv8tion.jda.api.events.guild.voice.GuildVoiceSelfMuteEvent]!
 *
 *
 ...
 */
class GuildVoiceMuteEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
     ...
     * <br></br>False, if the member was un-muted in this event
     */
    val isMuted: Boolean

    init {
        isMuted = member.voiceState!!.isMuted
    }
}
