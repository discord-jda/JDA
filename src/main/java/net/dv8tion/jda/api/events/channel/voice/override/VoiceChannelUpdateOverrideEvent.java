...
/**
 * Indicates that a {@link PermissionOverride} of a {@link VoiceChannel} has been updated or created.
 *
 * <p>Can be used to retrieve the updated override and old {@link #getOldAllow() allow} and {@link #getOldDeny() deny}.
 */
public class VoiceChannelUpdateOverrideEvent extends GenericVoiceChannelOverrideEvent
{
    private final long oldAllow, oldDeny;

    public VoiceChannelUpdateOverrideEvent(@Nonnull JDA api, long responseNumber, @Nonnull VoiceChannel channel, @Nonnull PermissionOverride override, long oldAllow, long oldDeny)
    {
