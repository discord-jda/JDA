...
/**
 * Indicates that a {@link SlashCommand} was deleted.
 *
...
{
    public ApplicationCommandDeleteEvent(@Nonnull JDA api, long responseNumber, @Nonnull SlashCommand command, @Nullable Guild guild)
    {
