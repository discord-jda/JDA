...
/**
 * Indicates that a [User][net.dv8tion.jda.api.entities.User] has stopped an [Activity]
 * in a [Guild].
 *
 *
 ...
 *
 *
 * The activities of the [Member] are updated before all start/end events are fired.
 * This means you can check [Member.getActivities] when handling this event and it
 ...
 * Iterate the list of activities and check if an activity of the same [type][Activity.getType]
...
class UserActivityEndEvent(
     ...
     */
    @get:Nonnull
    @param:Nonnull val oldActivity: Activity
