...
/**
 * Indicates that the [name][ForumTag.getName] of a [ForumTag] changed.
 *
 *
 * **Requirements**<br></br>
...
) : GenericForumTagUpdateEvent<String?>(api, responseNumber, channel, tag, previous, tag.name, IDENTIFIER) {
    @get:Nonnull
    val oldName: String?
        get() = oldValue
