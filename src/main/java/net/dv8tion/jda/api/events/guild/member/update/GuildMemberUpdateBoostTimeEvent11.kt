...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] updated their [Guild][net.dv8tion.jda.api.entities.Guild] boost time.
 * <br></br>This happens when a member started or stopped boosting a guild.
 *
 *
...
class GuildMemberUpdateBoostTimeEvent(
    ...
    companion object {
        const val IDENTIFIER = "boost_time"
    }
}
