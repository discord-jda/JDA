...
/**
 * Indicates that a {@link PermissionOverride} of a {@link StandardGuildChannel} has been updated.
 *
...
public class PermissionOverrideUpdateEvent extends GenericPermissionOverrideEvent
{
    ...
    public PermissionOverrideUpdateEvent(@Nonnull JDA api, long responseNumber, @Nonnull StandardGuildChannel channel, @Nonnull PermissionOverride override, long oldAllow, long oldDeny)
    {
