...
/**
 * Indicates that the username of a [User][net.dv8tion.jda.api.entities.User] changed. (Not Nickname)
 *
 *
 ...
 */
class UserUpdateNameEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull user: User, @Nonnull oldName: String?) :
    GenericUserUpdateEvent<String?>(api, responseNumber, user, oldName, user.name, IDENTIFIER) {
    @get:Nonnull
    val oldName: String?
        /**
         * The old username
