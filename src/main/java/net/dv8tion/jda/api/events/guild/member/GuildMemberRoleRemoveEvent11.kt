...
/**
 * Indicates that one or more [Roles][net.dv8tion.jda.api.entities.Role] were removed from a [Member][net.dv8tion.jda.api.entities.Member].
 *
 *
...
class GuildMemberRoleRemoveEvent(
    ...
    @Nonnull removedRoles: List<Role>?
    ...
    init {
        roles = Collections.unmodifiableList(removedRoles)
    }
}
