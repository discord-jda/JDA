...
/**
 * Indicates that a [Custom Emoji][RichCustomEmoji] was removed from a Guild.
 *
 *
 * **Requirements**<br></br>
 *
 ...
 */
class EmojiRemovedEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull emoji: RichCustomEmoji) :
