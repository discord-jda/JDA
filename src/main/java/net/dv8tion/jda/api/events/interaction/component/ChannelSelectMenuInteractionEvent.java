...
/**
 * Indicates that a custom {@link ChannelSelectMenu} on one of the bots messages was used by a user.
 *
 ...
 */
public class ChannelSelectMenuInteractionEvent extends GenericComponentInteractionCreateEvent implements ChannelSelectMenuInteraction {
    private final ChannelSelectMenuInteraction menuInteraction;

    public ChannelSelectMenuInteractionEvent(@Nonnull JDA api, long responseNumber, @Nonnull ChannelSelectMenuInteraction interaction)
    {
    ...
    @Nonnull
    @Override
    public ChannelSelectMenuInteraction getInteraction()
    {
