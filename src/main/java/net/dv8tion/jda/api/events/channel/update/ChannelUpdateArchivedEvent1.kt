...
/**
 * Indicates that a [Channel&#39;s][Channel] archived state has been updated.
 *
 *
 * Can be used to retrieve the old archived state and the new one.
 *
 *
 ...
 */
class ChannelUpdateArchivedEvent(
    @Nonnull api: JDA,
    responseNumber: Long,
    channel: Channel,
    oldValue: Boolean?,
    ...
    companion object {
        val FIELD = ChannelField.ARCHIVED
