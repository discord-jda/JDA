...
/**
 * Indicates that a [Member][net.dv8tion.jda.api.entities.Member] was (un-)suppressed.
 *
 *
 ...
 *
 * @see net.dv8tion.jda.api.entities.GuildVoiceState.isSuppressed
 */
class GuildVoiceSuppressEvent(@Nonnull api: JDA, responseNumber: Long, @Nonnull member: Member) :
     ...
     * <br></br>False, if the member was un-suppressed
     */
