...
/**
 * Indicates that a [User][net.dv8tion.jda.api.entities.User] was banned from a [Guild][net.dv8tion.jda.api.entities.Guild].
 *
 *
 * Can be used to retrieve the user who was banned (if available) and the triggering guild.
 * <br></br>**Note**: This does not directly indicate that a Member is removed from the Guild!
 *
 *
 * **Requirements**<br></br>
 *
...
class GuildBanEvent(
    ...
    /**
     * The banned [User][net.dv8tion.jda.api.entities.User]
     *
