 ...
 *
 * **Example**
 * <pre>`manager.setName("gamer-forum")
 * .setSlowmode(10)
...
`</pre> *
 */
interface ForumChannelManager : StandardGuildChannelManager<ForumChannel?, ForumChannelManager?>,
    ...
    /**
     * Sets the **<u>default layout</u>** of the selected [ForumChannel].
     *
     * @param  layout
    ...
    @Nonnull
    @CheckReturnValue
    fun setDefaultLayout(@Nonnull layout: ForumChannel.Layout?): ForumChannelManager?
}
