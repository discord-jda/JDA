 ...
 * <br></br>This should only be used if a [VoiceDispatchInterceptor][net.dv8tion.jda.api.hooks.VoiceDispatchInterceptor] has been provided.
 *
 *
...
interface DirectAudioController {
     ...
     * @see .reconnect
     */
    fun connect(@Nonnull channel: AudioChannel?)
     ...
     * @see .reconnect
     */
    fun disconnect(@Nonnull guild: Guild?)
     ...
     */
    fun reconnect(@Nonnull channel: AudioChannel?)
}
