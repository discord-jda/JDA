...
/**
 * Manager providing functionality common for all [StandardGuildChannels][net.dv8tion.jda.api.entities.channel.middleman.StandardGuildChannel].
 *
 *
 * **Example**
 ...
 */
interface StandardGuildChannelManager<T : StandardGuildChannel?, M : StandardGuildChannelManager<T, M>?> :
    IPermissionContainerManager<T, M>, IPositionableChannelManager<T, M>, ICategorizableChannelManager<T, M>
