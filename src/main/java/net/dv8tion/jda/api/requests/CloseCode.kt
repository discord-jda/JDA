 ...
 * <br></br>This was inspired from the [official documentation](https://discord.com/developers/docs/topics/gateway#disconnections)
 */
enum class CloseCode @JvmOverloads constructor(
    /**
     ...
     */
    @get:Nonnull val meaning: String,
    /**
     ...
     */
    @JvmField val isReconnect: Boolean = true
) {
    ...
    companion object {
        ...
        fun from(code: Int): CloseCode? {
            for (c in entries) if (c.code == code) return c
            return null
        }
    }
}
