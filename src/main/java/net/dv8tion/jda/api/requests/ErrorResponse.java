...
public enum ErrorResponse {
    ...
    CANNOT_CONSUME_UNCONSUMABLE_SKU(40018, "Only consumable SKUs can be consumed"),
    CANNOT_DELETE_NON_SANDBOX_ENTITLEMENTS(40019, "You can only delete sandbox entitlements"),
    ...
    CANNOT_MESSAGE_VC(50008, "Cannot send messages in a non-text channel"),
    ...
    INDEX_NOT_AVAILABLE(110000, "Index not yet available. Try again later"),
    ...
    GUILD_FILE_UPLOADS_LIMITED(400001, "Access to file uploads has been limited for this guild"),
