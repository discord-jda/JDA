 ...
 *
 *
 * **Must provide not-null [MessageReaction][net.dv8tion.jda.api.entities.MessageReaction] to compile a valid
 * pagination route.**
 *
 *
 * **Limits:**<br></br>
 ...
 *
 * **Example**<br></br>
 * <pre>`// Remove reactions for the specified emoji
 ...
 * @see Message.retrieveReactionUsers
 * @see MessageChannel.retrieveReactionUsersById
 * @see MessageChannel.retrieveReactionUsersById
 */
interface ReactionPaginationAction : PaginationAction<User?, ReactionPaginationAction?> {
    @get:Nonnull
