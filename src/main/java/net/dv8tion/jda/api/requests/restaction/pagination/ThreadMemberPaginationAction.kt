 ...
 *
 *
 * **Must provide not-null [ThreadChannel] to compile a valid
 * pagination route.**
 *
 *
 * **Limits:**<br></br>
 ...
 *
 * **Example**<br></br>
 * <pre>`// Count all thread members who are bots
 ...
 */
interface ThreadMemberPaginationAction : PaginationAction<ThreadMember?, ThreadMemberPaginationAction?> {
    @get:Nonnull
