...
/**
 * Specialized [RestAction] used to update an existing message sent by a [Webhook][net.dv8tion.jda.api.entities.Webhook] or [InteractionHook][net.dv8tion.jda.api.interactions.InteractionHook].
 *
 * @param <T>
...
interface WebhookMessageEditAction<T> : MessageEditRequest<WebhookMessageEditAction<T>?>,
