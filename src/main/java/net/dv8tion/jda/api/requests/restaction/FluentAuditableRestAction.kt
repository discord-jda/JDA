...
/**
 * Interface used to mixin the customization parameters for [AuditableRestActions][AuditableRestAction].
...
interface FluentAuditableRestAction<T, R : FluentAuditableRestAction<T, R>?> : AuditableRestAction<T> {
    @Nonnull
    override fun reason(reason: String?): R?
    @Nonnull
