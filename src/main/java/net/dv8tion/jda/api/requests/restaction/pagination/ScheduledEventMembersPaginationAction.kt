 ...
 *
 * **Example**<br></br>
 * <pre>`// Get every member interested in this event and add the members names to a list
...
`</pre> *
 */
interface ScheduledEventMembersPaginationAction : PaginationAction<Member?, ScheduledEventMembersPaginationAction?> {
    @get:Nonnull
    val guild: Guild?
}
