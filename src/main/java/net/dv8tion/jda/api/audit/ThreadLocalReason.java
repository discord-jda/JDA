...
public final class ThreadLocalReason
{
    ...
    /**
     * Sets the current reason that should be used for {@link net.dv8tion.jda.api.requests.RestAction RestAction}.
     *
     * @param reason
    ...
    /**
     * The current reason that should be used for {@link net.dv8tion.jda.api.requests.RestAction RestAction}.
     *
