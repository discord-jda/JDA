 ...
 * <br>This is used by {@link net.dv8tion.jda.api.entities.AudioChannel AudioChannel} to where the server that hosts the
 * {@link net.dv8tion.jda.api.entities.AudioChannel AudioChannel} is located.
 */
public enum Region
{
