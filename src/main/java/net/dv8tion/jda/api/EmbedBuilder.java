...
public class EmbedBuilder
{
     ...
     * (using {@link net.dv8tion.jda.api.entities.channel.middleman.MessageChannel#sendFile(java.io.File, net.dv8tion.jda.api.utils.AttachmentOption...) MessageChannel.sendFile(...)})
     ...
     *
     * @see    net.dv8tion.jda.api.entities.channel.middleman.MessageChannel#sendFile(java.io.File, String, net.dv8tion.jda.api.utils.AttachmentOption...) MessageChannel.sendFile(...)
     */
    @Nonnull
