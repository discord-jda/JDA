...
public class Command implements ISnowflake
{
     ...
     * <br>This changes when a command is updated through {@link net.dv8tion.jda.api.JDA#upsertCommand(CommandData) upsertCommand}, {@link net.dv8tion.jda.api.JDA#updateCommands() updateCommands},
     * {@link net.dv8tion.jda.api.JDA#editSlashCommandById(String) editSlashCommandById}, or {@link net.dv8tion.jda.api.JDA#editContextMenuById(String) editContextMenuById}
