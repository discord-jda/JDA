...
import net.dv8tion.jda.internal.interactions.component.select.UserSelectMenuImpl;
...
/**
 * Represents a user select menu in a message.
 ...
 */
public interface UserSelectMenu extends ActionComponent
{
    /**
    ...
    @Override
    @CheckReturnValue
    default UserSelectMenu asDisabled()
    {
    ...
    @Override
    @CheckReturnValue
    default UserSelectMenu asEnabled()
    {
    ...
    @Override
    @CheckReturnValue
    default UserSelectMenu withDisabled(boolean disabled)
    {
    ...
    {
        return new UserSelectMenuImpl(data).createCopy();
    }
    ...
    class Builder
    {
        ...
        /**
         * Creates a new {@link UserSelectMenu} instance if all requirements are satisfied.
         *
         * @throws IllegalArgumentException
         *         Throws if {@link #getMinValues()} is greater than {@link #getMaxValues()}
         *
         * @return The new {@link UserSelectMenu} instance
         */
        @Nonnull
        public UserSelectMenu build()
        {
            Checks.check(minValues <= maxValues, "Min values cannot be greater than max values!");
            return new UserSelectMenuImpl(customId, placeholder, minValues, maxValues, disabled);
        }
    }
}
