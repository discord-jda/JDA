 ...
 *
 *
 * **Note:**This interaction requires [monetization](https://discord.com/developers/docs/monetization/overview) to be enabled.
 */
interface IPremiumRequiredReplyCallback : IDeferrableCallback {
    @Nonnull
    @CheckReturnValue
    fun replyWithPremiumRequired(): PremiumRequiredCallbackAction?
}
