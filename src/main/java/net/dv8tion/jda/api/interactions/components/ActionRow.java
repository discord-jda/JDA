 ...
 */
@Deprecated
@ReplaceWith("net.dv8tion.jda.api.interactions.components.actionrow.ActionRow")
public class ActionRow implements LayoutComponent<ItemComponent>, MessageTopLevelComponent, ModalTopLevelComponent
{
