...
/**
 * Webhook API for a channel interaction. Valid for up to 15 minutes after the interaction.
 ...
 * <ul>
 *     <li>{@link ChannelInteraction#deferReply() Interaction.deferReply(...)}</li>
 *     <li>{@link ChannelInteraction#reply(String) Interaction.reply(...)}</li>
 ...
 * </ul>
 *
 * <p>When {@link ChannelInteraction#deferReply()} is used, the first message will act identically to {@link #editOriginal(String) editOriginal(...)}.
 * This means that you cannot make your deferred reply ephemeral through this interaction hook. You need to specify whether your reply is ephemeral or not directly in {@link ChannelInteraction#deferReply(boolean) deferReply(boolean)}.
 *
 * @see #editOriginal(String)
 * @see #deleteOriginal()
 * @see #sendMessage(String)
 */
public interface ChannelInteractionHook extends WebhookClient<Message>, InteractionHook
{
    /**
     * The interaction attached to this hook.
     *
     * @return The {@link ChannelInteraction}
     */
    @Nonnull
    ChannelInteraction getInteraction();
     ...
     */
    @Nonnull
    ChannelInteractionHook setEphemeral(boolean ephemeral);
     ...
     * For {@link ChannelInteraction#deferReply()} and {@link ChannelInteraction#reply(String)} this will be the reply message instead.
     *
