...
public interface InteractionHook extends WebhookClient<Message>
{
    ...
    @NotNull
    @CheckReturnValue
    default WebhookMessageUpdateAction<Message> editOriginalComponents(@NotNull Collection<? extends ComponentLayout> components)
    {
    ...
    @NotNull
    @CheckReturnValue
    default WebhookMessageUpdateAction<Message> editOriginalComponents(@NotNull ComponentLayout... components)
    {
        return editMessageComponentsById("@original", components);
    }
