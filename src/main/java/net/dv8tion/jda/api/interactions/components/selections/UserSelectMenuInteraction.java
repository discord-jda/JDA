...
/**
 * Component Interaction for a {@link UserSelectMenu}.
 *
 * @see SelectMenuInteractionEvent
 */
public interface UserSelectMenuInteraction extends ComponentInteraction
{
    @Nonnull
    @Override
    UserSelectMenu getComponent();

    /**
     * The {@link UserSelectMenu} this interaction belongs to.
     *
     * @return The {@link UserSelectMenu}
     *
     * @see    #getComponentId()
     */
    @Nonnull
    default UserSelectMenu getSelectMenu()
    {
        return getComponent();
    }
     ...
     */
    @Nonnull
    default List<User> getSelectedOptions()
    {
        List<User> values = getValues();
    ...
    @Nonnull
    @CheckReturnValue
    default RestAction<Void> editSelectMenu(@Nullable UserSelectMenu newMenu)
    {
