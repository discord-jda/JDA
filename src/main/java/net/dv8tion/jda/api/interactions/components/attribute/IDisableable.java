...
public interface IDisableable extends Component
{
     ...
     *
     * @see net.dv8tion.jda.api.interactions.components.tree.ComponentTree#replace(net.dv8tion.jda.api.interactions.components.replacer.ComponentReplacer) ComponentTree.replace(ComponentReplacer)
     */
    @Nonnull
    @CheckReturnValue
