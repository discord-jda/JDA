...
/**
 * Abstract representation for a Discord interaction used in a channel.
 ...
 * When using {@link #deferReply()} the first message sent to the {@link ChannelInteractionHook} will be identical to using {@link ChannelInteractionHook#editOriginal(String)}.
...
public interface ChannelInteraction extends Interaction
{
    ...
    /**
     * The {@link ChannelInteractionHook} which can be used to send deferred replies or followup messages.
     *
     ...
     */
    @Nonnull
    ChannelInteractionHook getHook();

    /**
     * Acknowledge this interaction and defer the reply to a later time.
     * <br>This will send a {@code <Bot> is thinking...} message in chat that will be updated later through either {@link ChannelInteractionHook#editOriginal(String)} or {@link ChannelInteractionHook#sendMessage(String)}.
     *
     ...
     * Your first message to the {@link ChannelInteractionHook} will inherit whether the message is ephemeral or not from this deferred reply.
     *
