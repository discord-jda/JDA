 ...
 * <br></br>These interactions may provide incomplete lists of options with invalid values as they represent partial command
 ...
 */
interface CommandAutoCompleteInteraction : IAutoCompleteCallback, CommandInteractionPayload {
    @get:Nonnull
    val focusedOption: AutoCompleteQuery?

    /**
     * The respective [MessageChannelUnion] for this interaction.
     *
     * @return The [MessageChannelUnion]
     */
    @Nonnull
    override fun getChannel(): MessageChannelUnion?
    @Nonnull
    override fun getGuildChannel(): GuildMessageChannelUnion {
        return super<IAutoCompleteCallback>.getGuildChannel() as GuildMessageChannelUnion
    }
}
