 ...
 */
public class SlashCommandData extends BaseCommand<SlashCommandData> implements CommandDataBase<SlashCommandData>
{
     ...
     *         </ul>
     */
    public SlashCommandData(@Nonnull String name, @Nonnull String description)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addOptions(@Nonnull OptionData... options)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addOptions(@Nonnull Collection<? extends OptionData> options)
    {
        Checks.noneNull(options, "Option");
     ...
     */
    @Nonnull
    public SlashCommandData addOption(@Nonnull OptionType type, @Nonnull String name, @Nonnull String description, boolean required)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addOption(@Nonnull OptionType type, @Nonnull String name, @Nonnull String description)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addSubcommands(@Nonnull SubcommandData... subcommands)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addSubcommands(@Nonnull Collection<? extends SubcommandData> subcommands)
    {
        Checks.noneNull(subcommands, "Subcommands");
     ...
     */
    @Nonnull
    public SlashCommandData addSubcommandGroups(@Nonnull SubcommandGroupData... groups)
    {
     ...
     */
    @Nonnull
    public SlashCommandData addSubcommandGroups(@Nonnull Collection<? extends SubcommandGroupData> groups)
    {
        Checks.noneNull(groups, "SubcommandGroups");
    ...
    public static SlashCommandData fromData(@Nonnull DataObject object)
    {
        ...
        SlashCommandData command = new SlashCommandData(name, description);
     ...
     */
    @Nonnull
    public static List<SlashCommandData> fromList(@Nonnull DataArray array)
    {
        Checks.notNull(array, "DataArray");
        return array.stream(DataArray::getObject)
                .map(SlashCommandData::fromData)
                .collect(Collectors.toList());
    }
     ...
     */
    @Nonnull
    public static List<SlashCommandData> fromList(@Nonnull Collection<? extends DataObject> collection)
    {
