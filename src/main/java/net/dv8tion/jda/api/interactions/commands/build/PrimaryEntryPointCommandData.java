...
public interface PrimaryEntryPointCommandData extends CommandData, IDescribedCommandData
{
    ...
    static PrimaryEntryPointCommandData fromCommand(@Nonnull Command command)
    {
        ...
        Checks.check(command.getType() == Command.Type.PRIMARY_ENTRY_POINT, "Cannot convert command of type %s to EntryPointCommandData!", command.getType());

        PrimaryEntryPointCommandDataImpl data = new PrimaryEntryPointCommandDataImpl(command.getName(), command.getDescription(), command.getHandler());
    ...
    static PrimaryEntryPointCommandData fromData(@Nonnull DataObject object)
    {
        ...
        Checks.check(commandType == Command.Type.PRIMARY_ENTRY_POINT, "Cannot convert command '%s' of type %s to PrimaryEntryPointCommandData!", name, commandType);

        final String description = object.getString("description");
        final Handler handler = Handler.fromValue(object.getLong("handler"));
        PrimaryEntryPointCommandDataImpl data = new PrimaryEntryPointCommandDataImpl(name, description, handler);
