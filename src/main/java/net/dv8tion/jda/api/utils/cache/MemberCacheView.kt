 ...
 * specifically to view [Members][net.dv8tion.jda.api.entities.Member].
 *
 *
 ...
 */
interface MemberCacheView : SnowflakeCacheView<Member?> {
    /**
     ...
     */
    override fun getElementById(id: Long): Member?
     ...
     * @return Possibly-null member for the specified ID
     */
    override fun getElementById(@Nonnull id: String?): Member? {
