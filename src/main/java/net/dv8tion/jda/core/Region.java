 ...
 * This is used by {@link net.dv8tion.jda.core.entities.Guild Guild} to where the server that hosts the
...
public enum Region
{
     ...
     * @return
     *          The {@link net.dv8tion.jda.core.Region Region} matching the key. If there is no match, returns {@link net.dv8tion.jda.core.Region#UNKNOWN UNKNOWN}.
     */
