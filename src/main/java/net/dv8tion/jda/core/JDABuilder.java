...
public class JDABuilder
{
     ...
     * <br>This will use and incremental reconnect (timeouts are increased each time an attempt fails).
     *
     ...
     *
     * <p></p>Please note, that a shard will not even know about guilds not assigned to.
     *
     * @param  shardId
