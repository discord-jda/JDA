...
{
    /**
     * Returns whether the {@link net.dv8tion.jda.core.entities.User User} muted himself
     *
    ...
    /**
     * Returns whether the {@link net.dv8tion.jda.core.entities.User User} got muted by an Admin (server side)
     *
     * @return
    ...
    /**
     * Returns whether the {@link net.dv8tion.jda.core.entities.User User} deafened himself
     *
     * @return
    ...
    /**
     * Returns whether the {@link net.dv8tion.jda.core.entities.User User} got deafened by an Admin (server side)
     *
     * @return
    ...
    /**
     * Returns true if this {@link net.dv8tion.jda.core.entities.User User} is unable to speak because the
     ...
     *
     * @return
     *      True if this {@link net.dv8tion.jda.core.entities.User User's} audio is being suppressed.
     */
    ...
    /**
     * Returns the {@link net.dv8tion.jda.core.entities.User User} corresponding to this VoiceStatus Object
     * (Backreference)
     *
     * @return
