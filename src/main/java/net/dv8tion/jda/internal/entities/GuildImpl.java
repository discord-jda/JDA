...
import net.dv8tion.jda.api.interactions.commands.build.UserCommandData;
...
public class GuildImpl implements Guild
{
        ...
        return new RestActionImpl<>(getJDA(), route,
                (response, request) ->
                        response.getArray()
                                ...
                                .map(json -> CommandType.fromKey(json.getInt("type", 1)).create(getJDA(), this, json))
    ...
    public RestAction<Command> retrieveCommandById(@Nonnull String id)
    {
        ...
        return new RestActionImpl<>(getJDA(), route, (response, request) -> {
            ...
            return CommandType.fromKey(obj.getInt("type", 1)).create(getJDA(), this, obj);
        });
    }

    @Nonnull
    @Override
    public CommandCreateAction upsertCommand(@Nonnull CommandDataBase<?> command)
    {
