...
public class ScheduledEventUpdateHandler extends SocketHandler {
    ...
    protected Long handleInternally(DataObject content) {
        ...
        location =
                    content.optObject("entity_metadata")
        ...
        if (!Objects.equals(name, event.getName())) {
            ...
            event.setName(name);
            getJDA().handleEvent(
                            new ScheduledEventUpdateNameEvent(
        ...
        if (!Objects.equals(description, event.getDescription())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateDescriptionEvent(
        ...
        if (!Objects.equals(startTime, event.getStartTime())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateStartTimeEvent(
        ...
        if (!Objects.equals(endTime, event.getEndTime())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateEndTimeEvent(
        ...
        if (!Objects.equals(status, event.getStatus())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateStatusEvent(
        ...
        if (channel == null && !location.equals(event.getLocation())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateLocationEvent(
        ...
        if (!Objects.equals(imageUrl, event.getImageUrl())) {
            ...
            getJDA().handleEvent(
                            new ScheduledEventUpdateImageEvent(
