...
public class WebSocketClient extends WebSocketAdapter implements WebSocketListener
{
    ...
    protected void setupHandlers()
    {
        ...
        handlers.put("GUILD_SOUNDBOARD_SOUND_CREATE",          new GuildSoundboardSoundsCreateHandler(api));
        handlers.put("GUILD_SOUNDBOARD_SOUND_UPDATE",          new GuildSoundboardSoundsUpdateHandler(api));
        handlers.put("GUILD_SOUNDBOARD_SOUND_DELETE",          new GuildSoundboardSoundsDeleteHandler(api));
