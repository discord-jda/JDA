...
public class GatewayBufferedMessageReader implements GatewayMessageReader {
    private final Decoder decoder;
    private final GatewayDecompressor.Transport.Buffered decompressor;

    public GatewayBufferedMessageReader(Decoder decoder, GatewayDecompressor.Transport.Buffered decompressor) {
