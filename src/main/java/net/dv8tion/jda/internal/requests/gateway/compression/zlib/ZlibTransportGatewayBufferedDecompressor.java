...
public class ZlibTransportGatewayBufferedDecompressor extends AbstractZlibTransportGatewayDecompressor
        implements GatewayDecompressor.Transport.Buffered {
    protected final int maxBufferSize;
    protected SoftReference<ByteArrayOutputStream> decompressBuffer = null;

    public ZlibTransportGatewayBufferedDecompressor(int maxBufferSize) {
    ...
    @Override
    public byte[] decompress(@Nonnull byte[] data) throws DecompressionException {
