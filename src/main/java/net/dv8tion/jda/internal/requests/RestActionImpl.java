...
public class RestActionImpl<T> implements RestAction<T>
{
    ...
    {
        this(api, route, data == null ? null : RequestBody.create(data.toJson(), Requester.MEDIA_TYPE_JSON), handler);
        this.rawData = data;
    }
    ...
    protected RequestBody getRequestBody(DataObject object)
    {
        ...
        return object == null ? null : RequestBody.create(object.toJson(), Requester.MEDIA_TYPE_JSON);
    }
    ...
    protected RequestBody getRequestBody(DataArray array)
    {
        ...
        return array == null ? null : RequestBody.create(array.toJson(), Requester.MEDIA_TYPE_JSON);
    }
