...
public class ChannelInteractionHookImpl extends AbstractWebhookClient<Message> implements ChannelInteractionHook
{
    public static final String TIMEOUT_MESSAGE = "Timed out waiting for interaction acknowledgement";
    private final ChannelInteractionImpl interaction;
    ...
    public ChannelInteractionHookImpl(@Nonnull ChannelInteractionImpl interaction, @Nonnull JDA api)
    {
    ...
    @Nonnull
    @Override
    public ChannelInteraction getInteraction()
    {
        return interaction;
    }
    ...
    @Nonnull
    @Override
    public ChannelInteractionHook setEphemeral(boolean ephemeral)
    {
