...
public class TextChannelUpdatePermissionsEvent extends GenericTextChannelUpdateEvent
{
    ...
    public TextChannelUpdatePermissionsEvent(JDA api, int responseNumber, TextChannel channel,
    ...
    public Map<Role, PermissionOverride> getRoleOverridesChangedNew()
    {
        if (this.roleOverrideChangedNew == null)
        {
            ...
            {
                roleOverrideNew.put(role, ((TextChannelImpl) channel).getRolePermissionOverrides().get(role));
            }
    ...
    public Map<User, PermissionOverride> getUserOverridesChangedNew()
    {
        if (this.userOverrideChangedNew == null)
        {
            ...
            {
                userOverrideNew.put(user, ((TextChannelImpl) channel).getUserPermissionOverrides().get(user));
            }
