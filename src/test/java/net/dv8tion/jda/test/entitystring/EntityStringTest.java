...
public class EntityStringTest {
    ...
    @Order(1)
    void testSimple() {
        assertThat(new EntityString(new AnEntity())).hasToString("AnEntity");
        assertThat(new EntityString(new AnEntity()).setName("AName")).hasToString("AnEntity:AName");
    }
    ...
    void testMetadataSnowflake() {
        ...
        assertThat(
                        new EntityString(new ASnowflake())
                                .addMetadata("MetaKey1", "Metadata1")
                                .addMetadata("MetaKey2", "Metadata2"))
